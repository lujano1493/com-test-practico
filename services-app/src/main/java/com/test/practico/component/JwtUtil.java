package com.test.practico.component;
...
public class JwtUtil {
    ...
    public String generateToken(User user) {
        ...
        Date expiration = new Date(System.currentTimeMillis() + (JWT_EXPIRATION *1000 * 60));
        ...
        MacAlgorithm signatureAlgorithm = Jwts.SIG.HS512;
